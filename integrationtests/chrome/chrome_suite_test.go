...
import (
	...
	"github.com/lucas-clemente/pstream/integrationtests/tools/testserver"
	"github.com/lucas-clemente/pstream/internal/protocol"
	"github.com/lucas-clemente/pstream/internal/utils"

	_ "github.com/lucas-clemente/pstream/integrationtests/tools/testlog"
...
func chromeTestImpl(version protocol.VersionNumber, url string, blockUntilDone func()) bool {
	userDataDir, err := ioutil.TempDir("", "pstream-test-chrome-dir")
	Expect(err).NotTo(HaveOccurred())
